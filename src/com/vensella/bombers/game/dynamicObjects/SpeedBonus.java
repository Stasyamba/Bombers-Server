...
public class SpeedBonus extends DynamicObject {

	//Constructor
	
	public SpeedBonus(BombersGame game, int x, int y) {
	...
	public GameEvent getActivateEvent() {
		return new GameEvent(getGame()) {
			...
			protected void ApplyOnGame(BombersGame game, DynamicGameMap map) {
				...
				params.putInt("game.DOAct.f.type", DynamicObjectManager.BONUS_ADD_SPEED);
